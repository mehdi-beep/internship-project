...
from app.models.enums import ApprovalDecision, ApprovalLevel, enum_values
...
class ApprovalHistory(Base):
    ...
    approval_level: Mapped[ApprovalLevel] = mapped_column(
        Enum(ApprovalLevel, name="approval_level", values_callable=enum_values), nullable=False
    )
    ...
    decision: Mapped[ApprovalDecision] = mapped_column(
        Enum(ApprovalDecision, name="approval_decision", values_callable=enum_values), nullable=False
    )
